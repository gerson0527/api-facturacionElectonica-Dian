...
export class Invoice extends TenantEntity {
  ...
  @Column({ type: 'varchar', length: 5, name: 'payment_form_code', default: '1' })
  paymentFormCode: string;

  @Column({ type: 'varchar', length: 5, name: 'payment_method_code', default: '10' })
  ...
  @Column({ type: 'decimal', precision: 20, scale: 2, default: 0, name: 'total_tax' })
  totalTax: number;

  @Column({ type: 'decimal', precision: 20, scale: 2, default: 0, name: 'total_amount' })
  totalAmount: number;
