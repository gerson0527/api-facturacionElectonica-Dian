...
export class InvoiceLine extends TenantEntity {
  ...
  @Column({ type: 'decimal', precision: 20, scale: 2, name: 'line_extension_amount' })
  lineExtensionAmount: number;

  @Column({ type: 'decimal', precision: 20, scale: 2, default: 0, name: 'tax_amount' })
  taxAmount: number;

  @Column({ type: 'varchar', length: 10, default: '01', name: 'tax_code' })
  taxCode: string;

  @Column({ type: 'decimal', precision: 5, scale: 2, default: 19, name: 'tax_percent' })
  taxPercent: number;
