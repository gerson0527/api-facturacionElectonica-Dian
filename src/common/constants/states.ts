...
export const ALLOWED_SUBMISSION_TRANSITIONS: Record<
  DianSubmissionStatus,
  DianSubmissionStatus[]
> = {
  [DianSubmissionStatus.CREATED]: [DianSubmissionStatus.SENDING],
  [DianSubmissionStatus.SENDING]: [
    DianSubmissionStatus.SENT,
    DianSubmissionStatus.FAILED,
  ],
  [DianSubmissionStatus.SENT]: [
    DianSubmissionStatus.PENDING,
    DianSubmissionStatus.FAILED,
  ],
  [DianSubmissionStatus.PENDING]: [
