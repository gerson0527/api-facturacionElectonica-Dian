...
@Module({
  imports: [
    TypeOrmModule.forFeature([
      CreditNote, Invoice, NumberingRange, DianSoftwareCredential,
  ...
  providers: [
    CreditNotesService, CufeService, XmlBuilderService, SigningService,
    DianSoapClient, PdfQrService, CryptoService,
