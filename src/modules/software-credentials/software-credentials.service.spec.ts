...
describe("SoftwareCredentialsService", () => {
  ...
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        ...
        {
          provide: getRepositoryToken(DianSoftwareCredential),
          useValue: credRepo,
        },
    ...
    service = module.get<SoftwareCredentialsService>(
      SoftwareCredentialsService,
    );
  });
  ...
  it("create cifra el pin y guarda la credencial", async () => {
    ...
    credRepo.create.mockImplementation(
      (payload: Partial<DianSoftwareCredential>) => payload,
    );
    credRepo.save.mockImplementation(
      async (payload: Partial<DianSoftwareCredential>) => payload,
    );
